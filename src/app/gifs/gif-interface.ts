// To parse this data:
//
//   import { Convert, GifResponseInterface } from "./file";
//
//   const welcome = Convert.toGifResponseInterface(json);
//
...
export class Convert {
    public static toGifResponseInterface(json: string): GifResponseInterface {
        return cast(JSON.parse(json), r('GifResponseInterface'));
    }

    public static welcomeToJson(value: GifResponseInterface): string {
        return JSON.stringify(uncast(value, r('GifResponseInterface')), null, 2);
    }
}
